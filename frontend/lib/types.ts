...
export const FEATURE_LABELS: Record<string, string> = {
  ...
  wopr: 'Weighted Opportunity Rate (WOPR)',
  dom: 'Dominator Rating (DOM)',
  w8dom: 'Weighted Dominator Rating (W8DOM)',
  receiving_epa: 'Receiving EPA',
  racr: 'Receiver Air Conv. Ratio (RACR)',
  yprr: 'Yards Per Route Run (YPRR)',
  team_pass_vol_trend: 'Team Pass Volume Trend',
  oc_change: 'OC Change',
  qb_change: 'QB Change',
}
